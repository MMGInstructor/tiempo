...
insert into City(id, name, weatherType, temp, maxTemp, minTemp, tempFeelsLike, wind) values ('lon','London', 'rainy-5', 9, 11, 7, 9, 3);
...
insert into City(id, name, weatherType, temp, maxTemp, minTemp, tempFeelsLike, wind) values ('get','Getafe', 'sunny', 23, 40, 3, 25, 20);
insert into City(id, name, weatherType, temp, maxTemp, minTemp, tempFeelsLike, wind) values ('tor','Torrejon', 'thunder', 28, 38, 1, 38, 12);
...
insert into Country_City (Country_id, cities_id) values ('es','get');
insert into Country_City (Country_id, cities_id) values ('es','tor');
